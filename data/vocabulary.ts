...
export const lessonVocabulary: { [key: string]: LearnedWord[] } = {
  ...
  "1.7": [
    { darija: "l-tnin", spanish: "Lunes", category: "Tiempo" },
    { darija: "t-tlat", spanish: "Martes", category: "Tiempo" },
    { darija: "l-arbe3", spanish: "Miércoles", category: "Tiempo" },
    { darija: "l-khmis", spanish: "Jueves", category: "Tiempo" },
    { darija: "j-jem3a", spanish: "Viernes", category: "Tiempo" },
    { darija: "s-sebt", spanish: "Sábado", category: "Tiempo" },
    { darija: "l-7ed", spanish: "Domingo", category: "Tiempo" },
    { darija: "lyum", spanish: "Hoy", category: "Tiempo", example: "Lyum kanqra (Hoy estudio)" },
    { darija: "ghedda", spanish: "Mañana (el día siguiente)", category: "Tiempo" },
    { darija: "l-bare7", spanish: "Ayer", category: "Tiempo" },
    { darija: "f-sba7", spanish: "Por la mañana", category: "Tiempo" },
    { darija: "f-l3shiya", spanish: "Por la tarde", category: "Tiempo" },
    { darija: "f-lil", spanish: "Por la noche", category: "Tiempo" },
  ],
  "2.1": [
  ...
  "7.1": [
    { darija: "N3as", spanish: "Duermo", category: "Verbos", example: "Ana n3as bkri (Duermo temprano)" },
    { darija: "Nkhdem", spanish: "Trabajo", category: "Verbos" },
    { darija: "Nqra / N9ra", spanish: "Leo / Estudio", category: "Verbos" },
    { darija: "Nfham", spanish: "Entiendo", category: "Verbos", example: "Ma fhemtsh (No he entendido)" },
    { darija: "Njri", spanish: "Corro", category: "Verbos" },
    { darija: "N3awn", spanish: "Ayudo", category: "Verbos", example: "N3awnek (Te ayudo)" },
  ],
  "7.2": [
    { darija: "Kanbghi", spanish: "Me gusta", category: "Verbos", example: "Kanbghi had shi (Me gusta esto)" },
    { darija: "Nqddar", spanish: "Puedo", category: "Verbos", example: "Nqddar n3awnek (Puedo ayudarte)" },
    { darija: "N7awl", spanish: "Intento", category: "Verbos" },
    { darija: "Nfakker", spanish: "Pienso / Recuerdo", category: "Verbos", example: "Nfakker fik (Pienso en ti)" },
  ],
  "8.1": [
